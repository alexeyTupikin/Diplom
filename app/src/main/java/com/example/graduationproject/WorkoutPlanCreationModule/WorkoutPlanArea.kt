...
class WorkoutPlanArea : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.fragmentWorkoutPlanDay1,
                R.id.fragmentWorkoutPlanDay2,
                R.id.fragmentWorkoutPlanDay3
            )
        )
        ...
        binding.buttonSavePlan.setOnClickListener {
            ...
            val refApplication = db.getReference("applications").child(clientName!!).child("status")
            refApplication.setValue("План создан")
